...
define('DB_NAME', 'sms'); // Replace with your actual database name
define('DB_USER', 'root'); // Default username for XAMPP MySQL is 'root'
define('DB_PASS', ''); // Leave the password empty
